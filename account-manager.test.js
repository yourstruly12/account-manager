...
// This resets the accounts before each test.
...
let result = processTransaction("Alice", "DEPOSIT", 500);
...
result = processTransaction("Alice", "WITHDRAWAL", 100);
...
processTransaction("Alice", "WITHDRAWAL", 100);
